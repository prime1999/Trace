...
type AllKnowledgeModalProps = {
  ...
  showSuggetsionsModal: boolean;
  setShowSuggetsionsModal: (value: boolean) => void;
};
...
export default function SuugestionsModal({
  suggestions,

  showSuggetsionsModal,
  setShowSuggetsionsModal,
  ...
  return (
    <Dialog open={showSuggetsionsModal} onOpenChange={setShowSuggetsionsModal}>
